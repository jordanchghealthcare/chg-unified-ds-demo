    ...
    <div data-theme={selectedTheme} className="p-16 flex flex-col gap-24 bg-base-white min-h-screen max-w-4xl mx-auto">
      ...
      <section className="bg-gray-50 rounded-12 p-16 space-y-12">
        ...
        <div className="flex flex-wrap gap-8">
          ...
          >
            <span className="flex items-center gap-6">
              <svg className="size-16" viewBox="0 0 256 319" fill="currentColor">
                <path d="M213.803 0c1.873-.053 3.447 1.396 3.52 3.267l2.612 62.092a3.275 3.275 0 0 1-5.579 2.498l-22.2-20.97-26.183 24.796a3.275 3.275 0 0 1-4.992-.442l-.063-.093a3.275 3.275 0 0 1 .475-4.324l26.197-24.81-23.955-22.627a3.275 3.275 0 0 1 2.445-5.587l47.723.2zM181.834 34.616l.072.073-.072-.073zM132.691 157.71c0 4.265 54.792 2.22 62.203-3.78 0-50.978-27.376-77.739-77.45-77.739-50.073 0-78.16 27.133-78.16 67.6 0 70.296 94.758 71.566 94.758 109.87 0 11.133-5.088 17.604-16.864 17.604-14.566 0-20.537-7.383-19.782-32.57 0-3.282-63.449-4.33-65.617 0-4.82 75.023 41.394 96.824 86.034 96.824 42.889 0 76.464-22.827 76.464-64.18 0-75.252-96.434-73.363-96.434-110.797 0-15.267 11.397-17.295 18.994-17.295 8.352 0 19.749 1.1 18.854 14.463z" />
              </svg>
              Storybook
            </span>
          </Button>
