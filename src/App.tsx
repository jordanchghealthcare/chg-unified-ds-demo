    ...
    <div data-theme={selectedTheme} className="p-16 flex flex-col gap-24 bg-base-white min-h-screen max-w-4xl mx-auto">
      ...
      <section className="bg-gray-50 rounded-12 p-16 space-y-12">
        ...
        <div className="flex flex-wrap gap-8">
          ...
          >
            <span className="flex items-center gap-6">
              <svg className="size-16" viewBox="0 0 150 150" fill="currentColor">
                <path d="M75 10C40 10 20 35 20 65c0 45 60 46 60 70 0 7-3 11-11 11-9 0-13-5-13-21 0-2-40-3-42 0-3 48 26 62 55 62 27 0 49-15 49-41 0-48-62-47-62-71 0-10 7-11 12-11 5 0 13 1 12 9 0 3 35 2 40-2 0-33-18-51-50-51z" />
              </svg>
              Storybook
            </span>
          </Button>
